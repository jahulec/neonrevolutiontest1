...
export function renderGallery({ locale, lang, gallery }) {
  ...
  <dialog class="gallery-lightbox" data-gallery-modal aria-label="${escapeHtml(locale.pages.gallery.heading)}">
    <div class="gallery-lightbox__backdrop" data-gallery-backdrop aria-hidden="true"></div>
    ...
    <figure data-gallery-stage><img data-gallery-image src="${escapeHtml(initial?.image ?? '/assets/sygnet-neon.webp')}" alt="${escapeHtml(initialAlt)}" loading="lazy" decoding="async" draggable="false"></figure>
