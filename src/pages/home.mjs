...
export function renderHome({ site, routes, locale, lang, releases, videos, shows }) {
    ...
    afterHeader: `<div class="post-hero">
      <section class="section music-section" id="music" aria-labelledby="music-title"><div class="content">
        ...
        <div class="music-layout">
          <a class="release-art" href="${escapeHtml(route('music'))}" aria-label="${escapeHtml(`${locale.view}: ${release.title}`)}"><img src="${escapeHtml(release.cover)}" width="1600" height="1600" alt="${escapeHtml(`${site.brand} — ${release.title}`)}" loading="lazy" decoding="async"></a>
      ...
      <section class="section video-section" id="video" aria-labelledby="video-title-heading"><div class="content">
        ...
        <a class="video-card" href="${escapeHtml(route('video'))}" aria-label="${escapeHtml(`${locale.view}: ${video.title}`)}"><img src="${escapeHtml(video.thumbnail)}" width="2048" height="1365" alt="" loading="lazy" decoding="async"><span class="video-shade" aria-hidden="true"></span><span class="play" aria-hidden="true"></span><span class="video-title">${escapeHtml(video.title)}</span></a>
      </div></section>
      ...
      <section class="section about-section" id="about" aria-labelledby="about-title"><div class="content">
        ...
        <div class="about-layout"><p class="about-copy">${escapeHtml(locale.bio)}</p><img class="about-mark" src="/assets/sygnet-neon.webp" width="1200" height="1200" alt="" aria-hidden="true" loading="lazy" decoding="async"></div>
      </div></section>
