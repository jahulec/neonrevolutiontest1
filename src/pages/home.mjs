...
export function renderHome({ site, routes, locale, lang, releases, videos, shows, press }) {
  ...
  return {
    beforeHeader: `<section class="hero" id="top" aria-labelledby="page-title">
      <div class="hero-media"><div class="hero-bg" aria-hidden="true"><img class="hero-bg__image" src="${escapeHtml(heroBackground)}" width="2048" height="1365" alt="" fetchpriority="high"></div><div class="crt-frame" aria-hidden="true"></div></div>
